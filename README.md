...
Phantom Grid operates in the tradition of Detroit Electro, Techno and Minimal Electronica as a living, forward-facing form — not retro reproduction, not European imitation. The sound is mechanical, aquatic, cold, and human simultaneously. Influences are explicit: UR's militancy, Drexciya's mythology, the technical precision of Clone Records. The label does not chase trends. It builds a body of work.

### Visual Identity

The visual language of Phantom Grid was initiated by Tobi through a series of founding drafts. The aesthetic is grid-based, monochrome-first, typographically precise, with selective use of cold accent color. The name itself — Phantom Grid — is a design directive: the grid is always present, sometimes visible, sometimes not.
...
├── roles/
│   ├── art-direction.md             ← Vera Cross — Visual Identity & Art Direction
│   ├── anr-curation.md              ← Leon Foss — A&R / Music Curation
│   └── social-media.md              ← Mara Fels — Social Media & Content
├── brand/
...
|------|---------|------|--------|
| Art Direction & Visual Identity | Vera Cross | `roles/art-direction.md` | ✅ Active |
| A&R / Music Curation | Leon Foss | `roles/anr-curation.md` | ✅ Active |
| Social Media / Content | Mara Fels | `roles/social-media.md` | ✅ Active |
...
Vera — we have a new signing. Producer name: T_FORM, Detroit-based.
...
5. **Tobi has final say.** All outputs are proposals until confirmed. The AI team informs and executes — it does not decide.

---

## About Tobias

Tobi is a developer and music producer with over 20 years of experience in music and code. He runs Tobeworks, a web development consultancy in the Rhein-Main region. He is also the founder of Logic Moon (dark cinematic ambient) and Aethery Fields (experimental lo-fi ambient), both active on Bandcamp and streaming platforms.
