...
**Output:** `export/mp3/` — fertige MP3s mit Tags, bereit für Bandcamp/Platforms
...
**8.2** Release-Datum und alle URLs in `release.md` → `PLATFORMS` eintragen
