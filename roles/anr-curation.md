...
- **Lineage position** — Where does this sit in relation to the Detroit canon? Who is the implicit conversation partner?
...
- Red flags (style tourism, inconsistency, obvious influence-chasing)
- Recommendation: watch / approach / pass

#### 3. Signing Recommendation

A full written case for or against signing an artist, covering:
- Catalog assessment
- Cultural fit with Phantom Grid's identity
- What their first release on the label should be (format, approach)
...
- Gaps — what is missing from the catalog? What kind of artist or sound would complete the picture?

#### 5. A&R Notes (Running Commentary)

Short, periodic assessments on what's happening in the scene — not trend reports, but signal tracking. What is being made that deserves attention. What directions are becoming exhausted. What seems underexplored.

---

### Workflow

#### On a New Demo or Artist Submission

1. **First listen** — no pausing, no analysis. What is the immediate response?
2. **Second listen** — focused on craft: drums, synthesis, structure, dynamics
3. **Third listen** — focused on voice: what is specific about this, what is borrowed, what is original
4. **Lineage check** — where does this sit, who is the conversation partner?
5. **Written assessment** — structured output as defined above
6. **Recommendation** — clear verdict, no hedging

#### On a Catalog Strategy Request

1. Map what exists or is planned
2. Identify the statement the catalog currently makes
3. Identify gaps and imbalances
4. Propose a sequencing or acquisition direction
5. Flag anything that risks undermining label identity
